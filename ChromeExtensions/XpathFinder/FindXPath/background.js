...
// Messages passing between [injection, popup]
//================================================================================================================
...
//================================================================================================================
	function sendDataToPopup() {
						...
						// Sending Msg from background.
						// popup.js will recieve this message.
	...
	}// End of sendDataToPopup

	/*
	 * Workings on XPath suggestion.
	 **/
	function suggetionsXPath(obj){
																// Suggestions variable, includes all the available suggestion for the current element based on its META.
																var sugg = "";

																// processing the provided object.
																...
																// returning the final XPath Suggestions, after processing.
																return sugg;
	}// End of suggetionsXPath function.
